...
//                .build();
    ...
    @DisplayName("GET/호스트 상세 테스트")
    @Test
    public void viewHostDetailTest() throws ParseException, IOException {
    //given
        // 1) user 정보 저장
        User user = userService.create(User.builder()
                .name("Jeeho Kim")
    ...
    // then
        assertThat(hostDto.getRegion()).isEqualTo(saveRequestDto.getRegion());
